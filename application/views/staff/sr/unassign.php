      ...
      <div class="dashboard container">
        ...
        <div class="body">
          ...
          <?php else: ?>
            <div class="confirm">
              <p>
                Apakah Anda yakin melakukan unassign gedung untuk SR
                <strong><?php echo $json->data->nama; ?> (<?php echo $json->data->nim; ?>)</strong>?
              </p>
              <div align="center">
                <?php echo form_open('/staff/sr/unassign/' . $json->data->id_sr); ?>
