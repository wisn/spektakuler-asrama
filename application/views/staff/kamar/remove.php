          ...
          <?php else: ?>
            <div class="confirm">
              <p>
                ...
                <strong>Kamar <?php echo $json->data->no_kamar; ?></strong>?
              </p>
              <div align="center">
                <?php echo form_open('/staff/kamar/remove/' . $json->data->id_kamar); ?>
                  <input type="submit" class="btn btn-danger" value="Hapus">
                  <a href="/staff/kamar/list" class="btn btn-primary">Batal</a>
                <?php echo form_close(); ?>
              </div>
            </div>
          <?php endif; ?>
