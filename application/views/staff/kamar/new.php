      ...
      <div class="dashboard container">
        ...
        <div class="body">
          ...
          <div class="form">
            ...
            <?php echo form_open('/staff/kamar/new/' . $id_gedung); ?>
              <input type="number" name="no_kamar" placeholder="Nomor Kamar*" class="form-control">
              <select name="kategori" class="form-control">
                <option value="mahasiswa">Mahasiswa</option>
                <option value="sr">Senior Residence</option>
              </select>
