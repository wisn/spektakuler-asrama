      ...
      <div class="dashboard container">
        ...
        <div class="body">
          ...
          <div class="form">
            ...
            <?php else: ?>
              <?php $mahasiswa = $mahasiswa->data[0]; ?>
              <?php echo form_open('/staff/penghuni/sr/' . $mahasiswa->id_mahasiswa . '/' . $id_gedung . '/new'); ?>
                <p align="center">
                  Assign <strong><?php echo $mahasiswa->nama; ?></strong>
                  (<strong><?php echo $mahasiswa->nim; ?></strong>) ke kamar:
                </p>
